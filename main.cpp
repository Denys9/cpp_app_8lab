	...
	case 6: {
		...
		case 1: {
			...
			case 2: {
				cout << "Enter your money(grn): ";
				cin >> grn;
				cout << "You will get: " << grn / 39 << " $.";
			}break;
			case 3: {
				cout << "Enter your money(grn): ";
				cin >> grn;
				cout << "You will get: " << grn / 44 << " rupee.";
			}break;
			case 4: {
				cout << "Enter your money(grn): ";
				cin >> grn;
				cout << "You will get: " << grn / 1.66 << " gems in BRAWL STARS.";
			}break;
		...
		case 2: {
			...
			case 1: {
				...
				cin >> dollar;
				cout << "You will get: " << dollar * 39 << " grn.";
			}break;
			case 2: {
				cout << "Enter your money($): ";
				cin >> dollar;
			...
			case 3: {
				cout << "Enter your money($): ";
				cin >> dollar;
				cout << "You will get: " << dollar * 114 << " rupee.";
			}break;
			case 4: {
				cout << "Enter your money($): ";
				cin >> dollar;
				cout << "You will get: " << dollar * 0.065 << " gems in BRAWL STARS.";
			}break;
			}
		default:
			break;
		...
		case 3: {
			...
			case 1: {
				...
				cin >> rupee;
				cout << "You will get: " << rupee * 0.27 << " grn.";
			}break;
			case 2: {
				cout << "Enter your money(rupee): ";
				cin >> rupee;
				cout << "You will get: " << rupee / 132 << " $.";
			}break;
			case 3: {
				cout << "Enter your money(rupee): ";
				cin >> rupee;
			...
			case 4: {
				cout << "Enter your money(rupee): ";
				cin >> rupee;
				cout << "You will get: " << rupee * 0.024 << " gems in BRAWL STARS.";
			}break;
			}break;
		}
		case 4: {
			...
			case 1: {
				...
				cin >> brawl_gem;
				cout << "You will get: " << brawl_gem * 1.60 << " grn.";
			}break;
			case 2: {
				cout << "Enter your money(gem): ";
				cin >> brawl_gem;
				cout << "You will get: " << brawl_gem / 0.65 << " $.";
			}break;
			case 3: {
				cout << "Enter your money(gem): ";
				cin >> brawl_gem;
				cout << "You will get: " << brawl_gem / 0.24 << " rupee.";
			}break;
			case 4: {
				cout << "Enter your money(gem): ";
				cin >> brawl_gem;
